...
const ProductDetails = ({ data }) => {
  ...
  const totalReviewsLength =
    products &&
    products.reduce((acc, allProducts) => acc + allProducts.reviews.length, 0);
  ...
  const totalRatings =
    ...
    products.reduce(
      (acc, allProducts) =>
        acc +
        allProducts.reviews.reduce((sum, review) => sum + review.rating, 0),
      0
    );
...
const ProductDetailsinfo = ({
  ...
  return (
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded">
      <div className="2-full flex justify-between border-b   pt-10 pb-2">
      ...
      {active === 2 ? (
        <div className="w-full  min-h-[48vh] flex flex-col items-center py-3 overflow-y-scroll">
          {data &&
