      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 3 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                You can track your by logging into your account on
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support rikamyvanol@gmail.com, or by calling us at +237 655 37 24 22
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Yes of course we offer international shipping to most countries. Shipping
                rates and delivery times vary depending on the destination. You can call our client service
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept visa,mastercard,paypal, mobilemoney , orangemoney payment method also we have
